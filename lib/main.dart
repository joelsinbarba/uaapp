...
import 'package:uaapp/maina.dart';
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Icon(
            const IconData(0xe801, fontFamily: "Ecampus"),
            color: Colors.white,
          ),
        ),
        Container(
      ...
      body: BlocBuilder(
          ...
          builder: (context, SemestreState state) {
            return Stack(children: <Widget>[
              _buildEventBackdrop(),
              TheSliver(scrollController: _scrollController, content: <Widget>[
                _Header(),
                Container(
                ...
                state.isSuccesfull && state.response != null
                    ...
                    : Container(),
                !state.hasReachedEndOfResults && !state.noMoreResults
                    ? Container(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                Image(
                                  image:
                                      AssetImage('assets/images/nothingHere.png'),
                                ),
                                SizedBox(height: 30,),
                                Text('No tienes cursos en el ' + state.response[indice].emptyYear.toString(),
                                    style: TextStyle(
